...
export default function IconBoxCard({
  ...
  return (
    <div className={`box-card ${className}`} style={vars}>
      <div className="margin-box-card d-flex flex-row align-items-center gap-3">
        ...
        <div className="box-card__content flex-grow-1 mb-0">
          {children}
        </div>
      </div>
    </div>
